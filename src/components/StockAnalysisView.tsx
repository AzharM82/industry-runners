...
export function StockAnalysisView() {
  ...
  return (
    <div className="min-h-[80vh] bg-[#F5F0E6] rounded-lg p-6">
      ...
      {loading && (
        <div className="flex flex-col items-center justify-center py-20">
          <div className="animate-spin rounded-full h-12 w-12 border-4 border-[#6B7B4C] border-t-transparent"></div>
          <p className="mt-4 text-[#6B6B6B]">Loading analysis for {searchedSymbol}...</p>
        </div>
      )}
        ...
        <div className="flex flex-col items-center justify-center py-12">
          <div className="bg-red-50 border border-red-200 rounded-lg p-6 max-w-md text-center">
            ...
            <button
              ...
              className="px-4 py-2 bg-[#6B7B4C] text-white rounded-lg hover:bg-[#5a6a3f] transition-colors"
            >
              Try Another Search
            </button>
          </div>
      ...
      {analysis && !loading && (
        <div className="space-y-6">
          ...
          <button
            onClick={handleNewSearch}
            className="flex items-center gap-2 text-[#6B7B4C] hover:text-[#5a6a3f] transition-colors"
          >
